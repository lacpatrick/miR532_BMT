...
``` {r import.data}
metadata <- read.csv("F:/Git/PLac Analyses/miR-532 project/miR532_BMT/Data/532_BMT_MetaData.csv")
JL_data <- read.csv("F:/Git/PLac Analyses/miR-532 project/miR532_BMT/Data/JL_532_BMT_Data.csv")
MB_data <- read.csv("F:/Git/PLac Analyses/miR-532 project/miR532_BMT/Data/MB_532_BMT_Data.csv")
PL_data <- read.csv("F:/Git/PLac Analyses/miR-532 project/miR532_BMT/Data/PL_532_BMT_Data.csv")
```
