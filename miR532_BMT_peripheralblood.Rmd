...
WBC <- ggplot(Week5, aes(x=Treatment, y=WBC)) +
  ...
  ylim(0, 12) +
  stat_summary(fun.data=mean_sdl, fun.args=list(mult=1), binwidth = 0.1, geom="errorbar", color="red", size=1, width=0.1) +
  stat_summary(fun.y=mean, geom="crossbar", color="red", size=0.5, width=0.15) +
