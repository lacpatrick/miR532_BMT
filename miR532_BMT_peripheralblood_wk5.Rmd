...
wk5.transplanter.WBC.control.comparisons <- list( c("Jeff Lam", "Marion van den Bosch"), c("Marion van den Bosch", "Patrick Lac"), c("Jeff Lam", "Patrick Lac"))
...
``` {r wk5.transplanter, fig.width=10, fig.height=4}
