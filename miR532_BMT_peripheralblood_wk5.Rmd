...
transplanter.RBC.control <- ggplot(all.control, aes(x=Transplant.performed.by., y=RBC, fill=Transplant.performed.by.)) +
  ...
  geom_dotplot(binaxis="y", binwidth = 0.1, stackdir="center", stackratio=2, dotsize=3.5) + 
  ylim(0, 15) +
  labs(title = "Red blood cells - Control", x = "Treatment", y = "RBC (10"^"6"*"/"~mu~"L)") +
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Transplanter", labels = c("Jeff Lam (n=11)", "Marion van den Bosch (n=0)", "Patrick Lac (n=9)")) +
  stat_compare_means(test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
...
transplanter.RBC.miR532 <- ggplot(all.miR532, aes(x=Transplant.performed.by., y=RBC, fill=Transplant.performed.by.)) +
  ...
  geom_dotplot(binaxis="y", binwidth = 0.1, stackdir="center", stackratio=2, dotsize=3.5) + 
  ylim(0, 15) +
  labs(title = "Red blood cells - miR-532", x = "Treatment", y = "RBC (10"^"6"*"/"~mu~"L)") +
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Treatment", labels = c("Jeff Lam (n=16)", "Marion van den Bosch (n=0)", "Patrick Lac (n=12)")) +
  stat_compare_means(test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
...
transplanter.HGB.control <- ggplot(all.control, aes(x=Transplant.performed.by., y=HGB, fill=Transplant.performed.by.)) +
  ...
  geom_dotplot(binaxis="y", binwidth = 0.1, stackdir="center", stackratio=3.5, dotsize=5) + 
  ylim(0, 20) +
  labs(title = "Hemoglobin - Control", x = "Treatment", y = "HGB (g/dL)") +
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Transplanter", labels = c("Jeff Lam (n=11)", "Marion van den Bosch (n=0)", "Patrick Lac (n=9)")) +
  stat_compare_means(test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
...
transplanter.HGB.miR532 <- ggplot(all.miR532, aes(x=Transplant.performed.by., y=HGB, fill=Transplant.performed.by.)) +
  ...
  geom_dotplot(binaxis="y", binwidth = 0.1, stackdir="center", stackratio=3.5, dotsize=5) + 
  ylim(0, 20) +
  labs(title = "Hemoglobin - miR-532", x = "Treatment", y = "HGB (g/dL)") +
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Treatment", labels = c("Jeff Lam (n=16)", "Marion van den Bosch (n=0)", "Patrick Lac (n=12)")) +
  stat_compare_means(test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
...
transplanter.HCT.control <- ggplot(all.control, aes(x=Transplant.performed.by., y=HCT, fill=Transplant.performed.by.)) +
 stat_summary(fun.data=mean_sdl, fun.args=list(mult=1), binwidth = 1, geom="errorbar", color="black", size=1.2, width=0.1) +
  ...
  geom_dotplot(binaxis="y", binwidth = 1, stackdir="center", stackratio=1.8, dotsize=2) + 
  ylim(0, 80) +
  labs(title = "Hematocrit - Control", x = "Treatment", y = "HCT (%)") +
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Transplanter", labels = c("Jeff Lam (n=11)", "Marion van den Bosch (n=0)", "Patrick Lac (n=9)")) +
  stat_compare_means(test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
...
transplanter.HCT.miR532 <- ggplot(all.miR532, aes(x=Transplant.performed.by., y=HCT, fill=Transplant.performed.by.)) +
 stat_summary(fun.data=mean_sdl, fun.args=list(mult=1), binwidth = 1, geom="errorbar", color="black", size=1.2, width=0.1) +
  ...
  geom_dotplot(binaxis="y", binwidth = 1, stackdir="center", stackratio=1.8, dotsize=2) + 
  ylim(0, 80) +
  labs(title = "Hematocrit - miR-532", x = "Treatment", y = "HCT (%)") +
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Treatment", labels = c("Jeff Lam (n=16)", "Marion van den Bosch (n=0)", "Patrick Lac (n=12)")) +
  stat_compare_means(test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
...
transplanter.MCV.control <- ggplot(all.control, aes(x=Transplant.performed.by., y=MCV, fill=Transplant.performed.by.)) +
 stat_summary(fun.data=mean_sdl, fun.args=list(mult=1), binwidth = 1, geom="errorbar", color="black", size=1.2, width=0.1) +
  stat_summary(fun.y=mean, geom="crossbar", color="black", size=0.6, width=0.2) +
  geom_dotplot(binaxis="y", binwidth = 1, stackdir="center", stackratio=1.1, dotsize=0.5) + 
  ylim(35, 55) +
  labs(title = "Mean corpuscular volume - Control", x = "Treatment", y = "MCV ("~mu~"m"^"3"*")") +
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Transplanter", labels = c("Jeff Lam (n=11)", "Marion van den Bosch (n=0)", "Patrick Lac (n=9)")) +
  stat_compare_means(test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
...
transplanter.MCV.miR532 <- ggplot(all.miR532, aes(x=Transplant.performed.by., y=MCV, fill=Transplant.performed.by.)) +
 stat_summary(fun.data=mean_sdl, fun.args=list(mult=1), binwidth = 1, geom="errorbar", color="black", size=1.2, width=0.1) +
  stat_summary(fun.y=mean, geom="crossbar", color="black", size=0.6, width=0.2) +
  geom_dotplot(binaxis="y", binwidth = 1, stackdir="center", stackratio=1.1, dotsize=0.5) + 
  ylim(35, 55) +
  labs(title = "Mean corpuscular volume - miR-532", x = "Treatment", y = "MCV ("~mu~"m"^"3"*")") +
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Treatment", labels = c("Jeff Lam (n=16)", "Marion van den Bosch (n=0)", "Patrick Lac (n=12)")) +
  stat_compare_means(test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
...
transplanter.MCH.control <- ggplot(all.control, aes(x=Transplant.performed.by., y=MCH, fill=Transplant.performed.by.)) +
  stat_summary(fun.data=mean_sdl, fun.args=list(mult=1), binwidth = 0.1, geom="errorbar", color="black", size=1.2, width=0.1) +
  stat_summary(fun.y=mean, geom="crossbar", color="black", size=0.6, width=0.2) +
  geom_dotplot(binaxis="y", binwidth = 0.1, stackdir="center", stackratio=2.5, dotsize=5) + 
  ylim(0, 20) +
  labs(title = "Mean corpuscular hemoglobin - Control", x = "Treatment", y = "MCH (pg)") +
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Transplanter", labels = c("Jeff Lam (n=11)", "Marion van den Bosch (n=0)", "Patrick Lac (n=9)")) +
  stat_compare_means(test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
...
transplanter.MCH.miR532 <- ggplot(all.miR532, aes(x=Transplant.performed.by., y=MCH, fill=Transplant.performed.by.)) +
  stat_summary(fun.data=mean_sdl, fun.args=list(mult=1), binwidth = 0.1, geom="errorbar", color="black", size=1.2, width=0.1) +
  stat_summary(fun.y=mean, geom="crossbar", color="black", size=0.6, width=0.2) +
  geom_dotplot(binaxis="y", binwidth = 0.1, stackdir="center", stackratio=2.5, dotsize=5) + 
  ylim(0, 20) +
  labs(title = "Mean corpuscular hemoglobin - miR-532", x = "Treatment", y = "MCH (pg)") +
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Treatment", labels = c("Jeff Lam (n=16)", "Marion van den Bosch (n=0)", "Patrick Lac (n=12)")) +
  stat_compare_means(test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
...
transplanter.MCHC.control <- ggplot(all.control, aes(x=Transplant.performed.by., y=MCHC, fill=Transplant.performed.by.)) +
stat_summary(fun.data=mean_sdl, fun.args=list(mult=1), binwidth = 0.1, geom="errorbar", color="black", size=1.2, width=0.1) +
  stat_summary(fun.y=mean, geom="crossbar", color="black", size=0.6, width=0.2) +
  geom_dotplot(binaxis="y", binwidth = 0.1, stackdir="center", stackratio=3, dotsize=10) + 
  ylim(0, 40) +
  labs(title = "Mean corpuscular \n hemoglobin concentration - Control", x = "Treatment", y = "MCHC (g/dl)") +
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Transplanter", labels = c("Jeff Lam (n=11)", "Marion van den Bosch (n=0)", "Patrick Lac (n=9)")) +
  stat_compare_means(test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
...
transplanter.MCHC.miR532 <- ggplot(all.miR532, aes(x=Transplant.performed.by., y=MCHC, fill=Transplant.performed.by.)) +
 stat_summary(fun.data=mean_sdl, fun.args=list(mult=1), binwidth = 0.1, geom="errorbar", color="black", size=1.2, width=0.1) +
  stat_summary(fun.y=mean, geom="crossbar", color="black", size=0.6, width=0.2) +
  geom_dotplot(binaxis="y", binwidth = 0.1, stackdir="center", stackratio=3, dotsize=10) + 
  ylim(0, 40) +
  labs(title = "Mean corpuscular \n hemoglobin concentration - miR-532", x = "Treatment", y = "MCHC (g/dl)") +
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Treatment", labels = c("Jeff Lam (n=16)", "Marion van den Bosch (n=0)", "Patrick Lac (n=12)")) +
  stat_compare_means(test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
...
transplanter.PLT.control <- ggplot(all.control, aes(x=Transplant.performed.by., y=PLT, fill=Transplant.performed.by.)) +
 stat_summary(fun.data=mean_sdl, fun.args=list(mult=1), binwidth = 3, geom="errorbar", color="black", size=1.2, width=0.1) +
  ...
  geom_dotplot(binaxis="y", binwidth = 1, stackdir="center", stackratio=5, dotsize=30) + 
  ylim(0, 1250) +
  labs(title = "Platelets - Control", x = "Treatment", y = "PLT (10"^"3"*"/"~mu~"L)") +
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Transplanter", labels = c("Jeff Lam (n=11)", "Marion van den Bosch (n=0)", "Patrick Lac (n=9)")) +
  stat_compare_means(test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
...
transplanter.PLT.miR532 <- ggplot(all.miR532, aes(x=Transplant.performed.by., y=PLT, fill=Transplant.performed.by.)) +
 stat_summary(fun.data=mean_sdl, fun.args=list(mult=1), binwidth = 3, geom="errorbar", color="black", size=1.2, width=0.1) +
  ...
  geom_dotplot(binaxis="y", binwidth = 1, stackdir="center", stackratio=5, dotsize=30) + 
  ylim(0, 1250) +
  labs(title = "Platelets - miR-532", x = "Treatment", y = "PLT (10"^"3"*"/"~mu~"L)") +
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Treatment", labels = c("Jeff Lam (n=16)", "Marion van den Bosch (n=0)", "Patrick Lac (n=12)")) +
  stat_compare_means(test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
...
transplanter.MPV.control <- ggplot(all.control, aes(x=Transplant.performed.by., y=MPV, fill=Transplant.performed.by.)) +
 stat_summary(fun.data=mean_sdl, fun.args=list(mult=1), binwidth = 0.1, geom="errorbar", color="black", size=1.2, width=0.1) +
  stat_summary(fun.y=mean, geom="crossbar", color="black", size=0.6, width=0.2) +
  geom_dotplot(binaxis="y", binwidth = 0.1, stackdir="center", stackratio=2, dotsize=2.5) + 
  ylim(0, 10) +
  labs(title = "Mean platelet volume - Control", x = "Treatment", y = "MPV ("~mu~"m"^"3"*")") +
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Transplanter", labels = c("Jeff Lam (n=11)", "Marion van den Bosch (n=0)", "Patrick Lac (n=9)")) +
  stat_compare_means(test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
...
transplanter.MPV.miR532 <- ggplot(all.miR532, aes(x=Transplant.performed.by., y=MPV, fill=Transplant.performed.by.)) +
 stat_summary(fun.data=mean_sdl, fun.args=list(mult=1), binwidth = 0.1, geom="errorbar", color="black", size=1.2, width=0.1) +
  stat_summary(fun.y=mean, geom="crossbar", color="black", size=0.6, width=0.2) +
  geom_dotplot(binaxis="y", binwidth = 0.1, stackdir="center", stackratio=2, dotsize=2.5) + 
  ylim(0, 10) +
  labs(title = "Mean platelet volume - miR-532", x = "Treatment", y = "MPV ("~mu~"m"^"3"*")") +
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Treatment", labels = c("Jeff Lam (n=16)", "Marion van den Bosch (n=0)", "Patrick Lac (n=12)")) +
  stat_compare_means(test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
...
transplanter.RDW.control <- ggplot(all.control, aes(x=Transplant.performed.by., y=RDW, fill=Transplant.performed.by.)) +
 stat_summary(fun.data=mean_sdl, fun.args=list(mult=1), binwidth = 0.1, geom="errorbar", color="black", size=1.2, width=0.1) +
  stat_summary(fun.y=mean, geom="crossbar", color="black", size=0.6, width=0.2) +
  geom_dotplot(binaxis="y", binwidth = 0.1, stackdir="center", stackratio=2.5, dotsize=6) + 
  ylim(0, 25) +
  labs(title = "RBC distribution width - Control", x = "Treatment", y = "RDW (%)") +
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Transplanter", labels = c("Jeff Lam (n=11)", "Marion van den Bosch (n=0)", "Patrick Lac (n=9)")) +
  stat_compare_means(test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
...
transplanter.RDW.miR532 <- ggplot(all.miR532, aes(x=Transplant.performed.by., y=RDW, fill=Transplant.performed.by.)) +
 stat_summary(fun.data=mean_sdl, fun.args=list(mult=1), binwidth = 0.1, geom="errorbar", color="black", size=1.2, width=0.1) +
  stat_summary(fun.y=mean, geom="crossbar", color="black", size=0.6, width=0.2) +
  geom_dotplot(binaxis="y", binwidth = 0.1, stackdir="center", stackratio=2.5, dotsize=6) + 
  ylim(0, 25) +
  labs(title = "RBC distribution width - miR-532", x = "Treatment", y = "RDW (%)") +
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Treatment", labels = c("Jeff Lam (n=16)", "Marion van den Bosch (n=0)", "Patrick Lac (n=12)")) +
  stat_compare_means(test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
...
transplanter.Number.Lym.control <- ggplot(all.control, aes(x=Transplant.performed.by., y=Number.Lym, fill=Transplant.performed.by.)) +
 stat_summary(fun.data=mean_sdl, fun.args=list(mult=1), binwidth = .1, geom="errorbar", color="black", size=1.2, width=0.1) +
  ...
  geom_dotplot(binaxis="y", binwidth = 0.05, stackdir="center", stackratio=3, dotsize=4) + 
  ylim(0, 8) +
  labs(title = "Lymphocyte count - Control", x = "Treatment", y = "Lym (10"^"3"*"/"~mu~"L)") +
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Transplanter", labels = c("Jeff Lam (n=11)", "Marion van den Bosch (n=0)", "Patrick Lac (n=9)")) +
  stat_compare_means(test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
...
transplanter.Number.Lym.miR532 <- ggplot(all.miR532, aes(x=Transplant.performed.by., y=Number.Lym, fill=Transplant.performed.by.)) +
 stat_summary(fun.data=mean_sdl, fun.args=list(mult=1), binwidth = .1, geom="errorbar", color="black", size=1.2, width=0.1) +
  ...
  geom_dotplot(binaxis="y", binwidth = 0.05, stackdir="center", stackratio=3, dotsize=4) + 
  ylim(0, 8) +
  labs(title = "Lymphocyte count - miR-532", x = "Treatment", y = "Lym (10"^"3"*"/"~mu~"L)") +
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Treatment", labels = c("Jeff Lam (n=16)", "Marion van den Bosch (n=0)", "Patrick Lac (n=12)")) +
  stat_compare_means(test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
...
transplanter.Number.Mon.control <- ggplot(all.control, aes(x=Transplant.performed.by., y=Number.Mon, fill=Transplant.performed.by.)) +
 stat_summary(fun.data=mean_sdl, fun.args=list(mult=1), binwidth = .1, geom="errorbar", color="black", size=1.2, width=0.1) +
  ...
  geom_dotplot(binaxis="y", binwidth = 0.05, stackdir="center", stackratio=1.2, dotsize=0.7) + 
  ylim(0, 1.5) +
  labs(title = "Monocyte count - Control", x = "Treatment", y = "Mon (10"^"3"*"/"~mu~"L)") +
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Transplanter", labels = c("Jeff Lam (n=11)", "Marion van den Bosch (n=0)", "Patrick Lac (n=9)")) +
  stat_compare_means(test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
...
transplanter.Number.Mon.miR532 <- ggplot(all.miR532, aes(x=Transplant.performed.by., y=Number.Mon, fill=Transplant.performed.by.)) +
 stat_summary(fun.data=mean_sdl, fun.args=list(mult=1), binwidth = .1, geom="errorbar", color="black", size=1.2, width=0.1) +
  ...
  geom_dotplot(binaxis="y", binwidth = 0.05, stackdir="center", stackratio=1.2, dotsize=0.7) + 
  ylim(0, 1.5) +
  labs(title = "Monocyte count - miR-532", x = "Treatment", y = "Mon (10"^"3"*"/"~mu~"L)") +
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Treatment", labels = c("Jeff Lam (n=16)", "Marion van den Bosch (n=0)", "Patrick Lac (n=12)")) +
  stat_compare_means(test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
...
transplanter.Number.Gra.control <- ggplot(all.control, aes(x=Transplant.performed.by., y=Number.Gra, fill=Transplant.performed.by.)) +
 stat_summary(fun.data=mean_sdl, fun.args=list(mult=1), binwidth = .1, geom="errorbar", color="black", size=1.2, width=0.1) +
  ...
  geom_dotplot(binaxis="y", binwidth = 0.1, stackdir="center", stackratio=2, dotsize=2) + 
  ylim(0, 8) +
  labs(title = "Granulocyte count - Control", x = "Treatment", y = "Gra (10"^"3"*"/"~mu~"L)") +
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Transplanter", labels = c("Jeff Lam (n=11)", "Marion van den Bosch (n=0)", "Patrick Lac (n=9)")) +
  stat_compare_means(test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
...
transplanter.Number.Gra.miR532 <- ggplot(all.miR532, aes(x=Transplant.performed.by., y=Number.Gra, fill=Transplant.performed.by.)) +
 stat_summary(fun.data=mean_sdl, fun.args=list(mult=1), binwidth = .1, geom="errorbar", color="black", size=1.2, width=0.1) +
  ...
  geom_dotplot(binaxis="y", binwidth = 0.1, stackdir="center", stackratio=2, dotsize=2) + 
  ylim(0, 8) +
  labs(title = "Granulocyte count - miR-532", x = "Treatment", y = "Gra (10"^"3"*"/"~mu~"L)") +
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Treatment", labels = c("Jeff Lam (n=16)", "Marion van den Bosch (n=0)", "Patrick Lac (n=12)")) +
  stat_compare_means(test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
...
transplanter.GFP.control <- ggplot(all.control, aes(x=Transplant.performed.by., y=GFP, fill=Transplant.performed.by.)) +
 stat_summary(fun.data=mean_sdl, fun.args=list(mult=1), binwidth = .1, geom="errorbar", color="black", size=1.2, width=0.1) +
  ...
  geom_dotplot(binaxis="y", binwidth = 0.5, stackdir="center", stackratio=2, dotsize=5) + 
  ylim(0, 100) +
  labs(title = "Engraftment - Control", x = "Treatment", y = "GFP+ (%)") +
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Transplanter", labels = c("Jeff Lam (n=11)", "Marion van den Bosch (n=0)", "Patrick Lac (n=9)")) +
  stat_compare_means(test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
...
stat_summary(fun.data=mean_sdl, fun.args=list(mult=1), binwidth = .1, geom="errorbar", color="black", size=1.2, width=0.1) +
  ...
  geom_dotplot(binaxis="y", binwidth = 0.5, stackdir="center", stackratio=2, dotsize=5) + 
  ylim(0, 100) +
  labs(title = "Engraftment - miR-532", x = "Treatment", y = "GFP+ (%)") +
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Treatment", labels = c("Jeff Lam (n=16)", "Marion van den Bosch (n=0)", "Patrick Lac (n=12)")) +
  stat_compare_means(test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
