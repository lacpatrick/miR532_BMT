...
``` {r wk5.transplanter.WBC, fig.width=4, fig.height=4}
comparisons <- list( c("Jeff Lam", "Marion van den Bosch"), c("Marion van den Bosch", "Patrick Lac"), c("Jeff Lam", "Patrick Lac"))

wk5.transplanter.WBC.control <- ggplot(wk5.all.control, aes(x=Transplant.performed.by., y=WBC, fill=Transplant.performed.by.)) +
  stat_summary(fun.data=mean_sdl, fun.args=list(mult=1), binwidth = 0.1, geom="errorbar", color="black", size=1.2, width=0.1) +
  stat_summary(fun.y=mean, geom="crossbar", color="black", size=0.6, width=0.2) +
  geom_dotplot(binaxis="y", binwidth = 0.1, stackdir="center", stackratio=2, dotsize=3) + 
  ylim(0, 12) +
  ...
  theme(plot.title = element_text(hjust=0.5), text=element_text(size=11)) +
  scale_fill_discrete(name="Treatment", labels = c("Jeff Lam (n=11)", "Marion van den Bosch (n=0)", "Patrick Lac (n=9)")) +
  stat_compare_means(test="kruskal.test", hjust=0, vjust=0.2, size=4) +
  theme(legend.position="top", legend.title=element_text(size=15), legend.text = element_text(size=15)) +
  theme(legend.position="none")

wk5.transplanter.WBC.miR532 <- ggplot(wk5.all.miR532, aes(x=Transplant.performed.by., y=WBC, fill=Transplant.performed.by.)) +
  stat_summary(fun.data=mean_sdl, fun.args=list(mult=1), binwidth = 0.1, geom="errorbar", color="black", size=1.2, width=0.1) +
  stat_summary(fun.y=mean, geom="crossbar", color="black", size=0.6, width=0.2) +
  geom_dotplot(binaxis="y", binwidth = 0.1, stackdir="center", stackratio=2, dotsize=3) + 
  ylim(0, 12) +
...
``` {r wk5.transplanter.RBC, fig.width=4, fig.height=4}
wk5.transplanter.RBC.control <- ggplot(wk5.all.control, aes(x=Transplant.performed.by., y=RBC, fill=Transplant.performed.by.)) +
  stat_summary(fun.data=mean_sdl, fun.args=list(mult=1), binwidth = 0.1, geom="errorbar", color="black", size=1.2, width=0.1) +
  stat_summary(fun.y=mean, geom="crossbar", color="black", size=0.6, width=0.2) +
  geom_dotplot(binaxis="y", binwidth = 0.1, stackdir="center", stackratio=2, dotsize=3.5) + 
  ylim(0, 15) +
...
wk5.transplanter.WBC.miR532 <- ggplot(wk5.all.miR532, aes(x=Transplant.performed.by., y=RBC, fill=Transplant.performed.by.)) +
  stat_summary(fun.data=mean_sdl, fun.args=list(mult=1), binwidth = 0.1, geom="errorbar", color="black", size=1.2, width=0.1) +
  stat_summary(fun.y=mean, geom="crossbar", color="black", size=0.6, width=0.2) +
  geom_dotplot(binaxis="y", binwidth = 0.1, stackdir="center", stackratio=2, dotsize=3.5) + 
  ylim(0, 15) +
...
``` {r wk5.transplanter, fig.width=10, fig.height=8}
wk5.WBC.transplanter <- ggarrange(wk5.transplanter.WBC.control, wk5.transplanter.WBC.miR532, 
          labels = "auto",
          ncol=2, nrow=2, common.legend = F, legend="none")
wk5.WBC.transplanter
```

``` {r wk5.transplanter, fig.width=10, fig.height=8}
wk5.RBC.transplanter <- ggarrange(wk5.transplanter.RBC.control, wk5.transplanter.RBC.miR532, 
          labels = "auto",
          ncol=2, nrow=2, common.legend = F, legend="none")
wk5.RBC.transplanter
```
